...
private:
    ...
    int num_of_word = 0;
public:
    void add_lexems_states(States State, char current, HashTable<string> ht_service, HashTable<string> ht_id) {
    ...
    vector <Lex> lex_analyze(string s, HashTable<string> ht_service, HashTable<string> ht_id) {
        lexems.clear();
    ...
    void debug_lexems_states(HashTable<string> ht_service, HashTable<string> ht_id) {
